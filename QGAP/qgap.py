...
def QGAP(prediction_type = None, y = None, prox_method = 'rfgap', 
    ...
    **kwargs
    ...
    if prediction_type == 'classification':
        rf = QUANTClassifier #(estimator=RandomForestClassifier)
    elif prediction_type == 'regression':
        rf = QUANTRegressor #(estimator=RandomForestRegressor)
    ...
    class QGAP(rf):
        ...
        def __init__(self, prox_method = prox_method, matrix_type = matrix_type, 
            ...
            super(QGAP, self).__init__(**kwargs)
